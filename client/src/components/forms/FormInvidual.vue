<template>
    <div v-if="isModalVisible" class="overlay">
        <form class="form-container" @submit.prevent="submitMail">
            ...
            <div class="form-group">
                <div class="form-element">
                    ...
                    <select name="city" id="city" v-model="formData.city">
                      <option value="null">--Wählen--</option>
                      <option v-for="city in filteredCities" :value="city.city_name">{{ city.city_name }}</option>
                    </select>
                </div>
                <div class="form-element">
                    ...
                    <select name="station-type" id="station-type" v-model="formData.stationType">
                      <option value="null">--Wählen--</option>
                      <option v-for="station in stations" :value="station.station_type_name">{{ station.station_type_name }}</option>
                    </select>
                </div>
            </div>
...
export default {
    ...
    data() {
        return {
            ...
            formData: {
                title: 'Antragsformular für individuelle Nutzung',
                nameSurname: null,
                phone: null,
                email: null,
                country: null,
